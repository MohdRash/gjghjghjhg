            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
              <div>
                ...
                <ul className="mt-4 space-y-4 text-muted-foreground md:text-xl">
                  ...
                  <li>
                    <span className="font-semibold text-foreground">Footprints:</span> Banda Aceh, Aceh, Indonesia
                  </li>
                  <li>
                    <span className="font-semibold text-foreground">Footprints:</span> Science Park, Dubai, UAE
                  </li>
                  <li>
                    <span className="font-semibold text-foreground">Tech Space:</span> Door.No. 36/267, Mannath Building, Thrikkakara, Eranamkulam, Kerala, India
                  </li>
                </ul>
              </div>
              <div>
